...
export function diagnosticHint(code) {
  const hints = {
    ...
    CUDA_INCOMPATIBLE: "Engine đã dùng CPU fallback. Cập nhật driver/runtime rồi bấm Thử lại GPU.",
    GPU_RETRY_FAILED: "GPU vẫn chưa sẵn sàng; engine tiếp tục dùng CPU fallback để tránh gián đoạn.",
    RUNTIME_DLL_MISSING: "Runtime thiếu DLL bắt buộc. Không tải DLL rời từ Internet; hãy cài hoặc sửa runtime Koharu.",
    RUNTIME_DLL_INCOMPATIBLE: "DLL không khớp phiên bản engine. Không trộn DLL giữa runtime cũ và runtime 0.70.2.",
    RUNTIME_INCOMPLETE: "Dọn gói cài dở trong Quản lý kho engine, sau đó nạp lại engine.",
